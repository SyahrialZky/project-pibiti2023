...
<title>{{config('app.name')}} - Belum Verifikasi</title>
@section('section')
    ...
    {{-- <a href="{{ url('ListUser') }}">
        <button type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 mt-10 ms-9">Kembali</button>
    </a> --}}
    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Belum Verifikasi</h1>
            </div>
            <div class="sm:flex">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <form action="{{ url("VerifikasiUser/".$item->id."/edit") }}" method="post" onclick="return confirm('Apakah Anda yakin ingin memverifikasi user ini?')">
                                        @csrf
                                        @method('PUT')
                                        <button type="submit" class="focus:outline-none text-white bg-lime-500 hover:bg-lime-600 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Verifikasi</button>
                                    </form>
                                </td>
                            </tr>   
                            @endforeach                     

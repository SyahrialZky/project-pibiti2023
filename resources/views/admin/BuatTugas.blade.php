...
@section('section')
    ...
    <form action="{{ route('TugasAdmin.Store') }}" method="POST">
        @csrf

        <div class="form-tambah-materi">
            <div class="bg-white p-5 shadow-sm mt-1 md:mt-10 rounded-lg w-full">
                <label for="judul" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Judul</label>
            ...
            <div class="bg-white p-5 shadow-sm rounded-lg w-full">
                ...
                <input type="text" id="url" name="urltugas"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div class="mt-5">
        <a href="{{ route('TugasAdmin.Index') }}">
            <button type="submit" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 sm:w-auto dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800 ms-4">
                Kembali
            </button> 
        </a>
    </div>

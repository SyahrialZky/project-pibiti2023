...
class SessionController extends Controller
{
    ...
    function loginFunc(Request $request)
    {
        ...
        if (Auth::attempt($infologin)) {
            ...
            return redirect()->route('auth.login.view')->withErrors('Username dan password yang dimasukkan tidak sesuai');
        }
    }
    ...
    function registerFunc(Request $request)
    {
        ...
        if (Auth::attempt($infologin)) {
            ...
            return redirect()->route('auth.register.view')->withErrors('Username dan password yang dimasukkan tidak sesuai');
        }
